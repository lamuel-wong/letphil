...
const storeName = "QuickShop"; // const since the storeName is predefined and won't change during execution of the program
const budget = 100; // const since budget won't be reassigned
const itemLimit = 30; // const since itemLimit won't change during execution
const discountThreshold = 80; // const since the threshold is a set rule that won't change
const discountRate = 0.10; // const since the percentage is fixed and doesn't change
let cartTotal = 0; // let since the total will be accumulated and changed as items get added
let itemsAdded = 0; // let since added items will increment as more gets added to the cart
let itemsSkipped = 0; // let since items skipped will increment
