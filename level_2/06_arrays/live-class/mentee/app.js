...
// Arrays are indexed.  A 5 element array and it has indexes from 0-4. Playlist.length = 5 - 1 = 4. Thriiler
...
playlist[1] = "Billie Jean";

console.log(playlist);

playlist[3] = "Smooth Criminal";
